                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            value="{{ old('email') }}"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('email') border-error-500 focus:border-error-500 focus:ring-error-500/10 dark:border-error-400 @else border-gray-300 dark:border-gray-700 @enderror" 
                                        />
                                        @error('email')
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input 
                                                ...
                                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('password') border-error-500 focus:border-error-500 focus:ring-error-500/10 dark:border-error-400 @else border-gray-300 dark:border-gray-700 @enderror" 
                                            />
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Login to style and setup your invitation.
                        </p>
                    </div>
                </div>
            </div>
