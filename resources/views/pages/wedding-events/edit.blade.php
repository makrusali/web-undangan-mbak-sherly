...
@section('content')
    <x-common.page-breadcrumb pageTitle="Edit Wedding Event" />
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
        <form method="POST" action="{{ route('panel.wedding-events.update', $weddingEvent) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        name="name"
                        value="{{ old('name', $weddingEvent->name) }}"
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div>
                        ...
                        <input 
                            type="date" 
                            name="date"
                            value="{{ old('date', $weddingEvent->date->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input 
                            type="time" 
                            name="time_start"
                            value="{{ old('time_start', $weddingEvent->time_start ? $weddingEvent->time_start->format('H:i') : '') }}"
                    ...
                    <div>
                        ...
                        <input 
                            type="time" 
                            name="time_end"
                            value="{{ old('time_end', $weddingEvent->time_end ? $weddingEvent->time_end->format('H:i') : '') }}"
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        name="location_name"
                        value="{{ old('location_name', $weddingEvent->location_name) }}"
                ...
                <div>
                    ...
                    <input 
                        type="url" 
                        name="gmaps_link"
                        value="{{ old('gmaps_link', $weddingEvent->gmaps_link) }}"
                ...
                <div>
                    ...
                    >{{ old('description', $weddingEvent->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-error-600 dark:text-error-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <img src="{{ $weddingEvent->image_url }}" alt="{{ $weddingEvent->name }}" class="w-32 h-32 object-cover rounded-lg border border-gray-200">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input 
                            type="number" 
                            name="sort_order"
                            value="{{ old('sort_order', $weddingEvent->sort_order) }}"
                    ...
                    <div class="flex items-center gap-2 pt-8">
                        <input 
                            ...
                            id="is_active"
                            value="1"
                            {{ old('is_active', $weddingEvent->is_active) ? 'checked' : '' }}
                ...
                <div class="flex items-center justify-end gap-3 pt-4">
                    <a 
                        href="{{ route('panel.wedding-events.show', $weddingEvent) }}"
