...
<aside id="sidebar"
    ...
    <div class="pt-8 pb-7 flex"
            ...
            'justify-start'">
            <a href="/">
                <!-- Full Logo (when sidebar expanded) -->
                <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                    class="flex items-center gap-2">
                    <div class="w-8 h-8 bg-brand-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">
                        K
                    </div>
                    <span class="text-xl font-bold text-gray-800 dark:text-white">kendah</span>
                </div>
                
                <!-- Icon Only (when sidebar collapsed) -->
                <div x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                    class="w-8 h-8 bg-brand-600 rounded-lg flex items-center justify-center text-white font-bold text-xl mx-auto">
                    K
                </div>
            </a>
    </div>
